...
function SearchHelp() {
  return (
    <div className="flex justify-between ">
      ...
      <div className="w-1/2">
        <div className="container_input flex items-center  h-10 rounded w-full bg-white bg-opacity-70">
          <input
            type="text"
            placeholder="Search for questions"
            className="w-full h-full px-5 outline-none bg-transparent placeholder:text-sm"
          />
          <i className="fa-solid fa-magnifying-glass  m-1 h-9 w-11 rounded flex items-center justify-center bg-[#FF472E] text-white "></i>
        </div>
        <div>
