...
function MoreToLoveCard({ productItems, addToCart, addToFavourite }) {
  
  return (
    <>
      {productItems.map((item, index) => {
        return (
          <div key={index} className="group bg-[#fff] relative shadow-md rounded-md m-2 flex-grow flex flex-col justify-between  h-72  ">
            <div className="h-48 my-8 flex flex-col justify-center items-center">
              ...
              <img src={item.cover} alt="" className="w-28" />
